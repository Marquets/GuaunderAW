...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-06-2017 a las 01:15:41
...
`ID` int(11) NOT NULL,
  ...
  `descripcion` varchar(255) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL DEFAULT 'AÃ±ade una descripciÃ³n para que la gente te conozca mÃ¡s',
...
(18, 'ayoub', 'Ayoub', '1995-01-12', '$2y$10$qGDkP6LvI5X.KfdhKMsj4.NWKhn5l4CpZl/B.umfjVchNb1RiB.aC', 'Parla', 'ayoub@ucm.es', '2017-05-29 10:53:07', '2017-06-01 23:51:23', '"img/foto_defecto.jpg"', 'AÃ±ade una descripciÃ³n para que la gente te conozca mÃ¡s', 0),
(23, 'alexoncio', 'lobo', '1995-09-24', '$2y$10$T8rhF0hF2iOHEInEx.CzHelJVvqN1v3ixBfpkPDjXvibE5zitvGJW', 'torrelodones, madrid', 'alexmonteroroldan@gmail.com', '2017-06-02 16:51:56', '2017-06-02 18:27:51', '"img/Perro.jpg"', 'AÃ±ade una descripciÃ³n para que la gente te conozca mÃ¡s', 0),
(24, 'bolita', 'boli', '2000-08-02', '$2y$10$ZNmEhHjc37zbwSZXrb9yIuRMQO7/CChR7/smdmUnjRO60BKlRlxK2', 'madrid', 'bolita@gmail.com', '2017-06-02 16:58:13', '2017-06-04 00:58:28', '"img/este-perro-es-la-definicion-perfecta-de-una-bola-de-pelo_6927_w620.jpg"', 'AÃ±ade una descripciÃ³n para que la gente te conozca mÃ¡s', 3),
(25, 'pepe', 'Pepe', '1950-01-12', '$2y$10$6d.p8HmeHlKu1oXmVSsviO2I8h9y094YhqbF.Dlodqef9CJDyoVlq', 'Plaza EspaÃ±a, Madrid', 'pepe@hotmail.com', '2017-06-02 18:15:48', '2017-06-02 18:34:59', '"img/perro_bicolor.jpg"', 'AÃ±ade una descripciÃ³n para que la gente te conozca mÃ¡s', 0),
(26, 'lobo', 'lobo', '2001-01-01', '$2y$10$by01RjcaLut1soFDXqIcl.XcOr1EJmNCF0mWu35lbMb8qPy3vi/vq', 'colmenarejo', 'lobo@hotmail.com', '2017-06-02 18:28:42', '2017-06-02 18:28:42', '"img/foto_defecto.jpg"', 'AÃ±ade una descripciÃ³n para que la gente te conozca mÃ¡s', 0),
(27, 'kika', 'kika', '2012-06-02', '$2y$10$iHZeqpC5131HF7JRV25ZDejx5477muV2uHITvTKITqxeqbjepzl9W', 'AÃ±ade tu ubicaciÃ³n', 'kika@hotmail.com', '2017-06-02 18:35:33', '2017-06-02 18:35:33', '"img/foto_defecto.jpg"', 'AÃ±ade una descripciÃ³n para que la gente te conozca mÃ¡s', 0),
(28, 'trikidraco', 'Draco', '2006-08-28', '$2y$10$CeateAXHQe5bBGTAxwWHxeFJ1NRj5NhUC1knHX/pp./H64CUzkB5.', 'Usera, EspaÃ±a', 'trikidraco@gmail.com', '2017-06-02 22:37:45', '2017-06-03 23:40:20', '"img/draco.jpg"', 'AÃ±ade una descripciÃ³n para que la gente te conozca mÃ¡s', 0);
